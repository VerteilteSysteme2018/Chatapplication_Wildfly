...
public abstract class AbstractMessageListenerThread extends Thread {
	...
	// JMS
	protected ChatClientJMS client;
	...
	// JMS
	public AbstractMessageListenerThread(ChatClientJMS client, Connection con, SharedClientData sharedData) {
	...
	// JMS part
	protected void handleUserListEvent(String user) {

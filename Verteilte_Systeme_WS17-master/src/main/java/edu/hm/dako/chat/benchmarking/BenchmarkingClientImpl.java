...
import edu.hm.dako.chat.sandboxBenchmarking.ChatClientJMS;
import edu.hm.dako.chat.sandboxBenchmarking.SimpleJMSMessageListenerThread;

public class BenchmarkingClientImpl extends ChatClientJMS
	...
	private void startMessageListenerThread() {
		...
		case JMSImplementation:
			...
			try {
				...
				messageListenerThread = new SimpleJMSMessageListenerThread(this, connection, sharedClientData, threadName, numberOfMessagesToSend);
				messageListenerThread.start();
			} catch (Exception e) {
				ExceptionHandler.logException(e);
			}

...
public class SimpleMessageListenerThreadImpl extends AbstractMessageListenerThread {
	...
	ClientManager clientManager = new ClientManager("listenerThread", "127.0.0.1", "8080");
	int count = 0;
	...
	//JMS
	public SimpleMessageListenerThreadImpl(ClientUserInterface client, SharedClientData sharedData) {
		super(client, null, sharedData);
	}

...
Datenbanken im Chatprozess um Nachrichten zu speichern und protokollieren. MariaDB verwendet. Um die Anforderungen eines verteilten Systems gerecht zu werden werden die Datenbankinstanzen in einem Dockercontainer\footnote{\url{https://www.docker.com/}} betrieben. Da Docker im Gegensatz zu einer virtuellen Maschine das Host-Betriebssystem mitbenutzt, können ressourcensparend leichtgewichtige, isolierte Container zur Verfügung gestellt werden, die aber dennoch über ein eigenes Dateisystem und Netzwerk-Interface verfügen.\cite{Docker:Functionality}

%TODO removed REST und GraphQL weil wegen eigentlich keine Infrastruktur?


%################################################################################
\section{Umsetzung}
Im Folgenden wird die Umsetzung der Anforderungen 
\subsection{Aufbau Server}
%Wildfly beinhaltet bereits eine Vielzahl von Subsystemen, weshalb kein separater \ac{JMS}-Provider oder Transaktionsmanager zu installieren ist.

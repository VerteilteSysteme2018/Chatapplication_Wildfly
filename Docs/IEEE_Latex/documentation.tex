...
\begin{abstract}
Aufbau einer Chat Applikation unter Einsatz einer Message-Oriented-Middleware -- Praktikum Verteilte Systeme.
\end{abstract}

% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
Verteilte Systeme, MOM, Wildfly, JMS, JavaEE, Transactions, JPA, Docker, Angular, GraphQL, ReST
\end{IEEEkeywords}}
...
\IEEEPARstart{D}{iese} Studienarbeit beschreibt die Chat-Applikation, die im Rahmen des Praktikums im Fach \textit{Verteilte Systeme} im Wintersemester 2017/2018. 
...
\begin{table}[h!]
	\caption{Aufbau der Trace-Tabelle.}
	\label{tab:trace}
	\def\arraystretch{1} % vertical stretch factor, 1.25 for more spacing
	\centering
	\begin{tabular}{||c|c||}\hline
		\textbf{Spaltenname}  & \textbf{Funktion} \\ \hline \hline
		\lstinline|id|           & Eindeutige Id             \\ \hline
		\lstinline|username|       & Chat-Nutzer Name             \\ \hline
		\lstinline|clientthread|        & Thread-Name des Clients             \\ \hline
		\lstinline|message|        & Die gesendete Nachricht             \\\hline 
	\end{tabular} 
\end{table}

\begin{table}[h!]
	\caption{Aufbau der Count-Tabelle.}
	\label{tab:count}
	\def\arraystretch{1} % vertical stretch factor, 1.25 for more spacing
	\centering
	\begin{tabular}{||c|c||}\hline
		...
		\lstinline|id|           & Eindeutige Id             \\ \hline
		\lstinline|username|       & Chat-Nutzer Name             \\ \hline
		\lstinline|counter|        & Zähler der gesendeten Nachrichten             \\\hline
	\end{tabular} 
\end{table}
...
%	\begin{tabular}{||c|c||}\hline
%		\textbf{Spaltenname}  & \textbf{Funktion} \\ \hline \hline
%		id           & Eindeutige Id             \\ \hline
%		username       & Chat-Nutzer Name             \\ \hline
%		clientthread        & Thread-Name des Clients             \\ \hline
%		message        & Die gesendete Nachricht             \\\hline 
%	\end{tabular}
%	\label{tbl:TraceSpalten}
%	\caption{Spalten der Trace-Tabelle}
%\end{table}
...
%		id           & Eindeutige Id             \\ \hline
%		username       & Chat-Nutzer Name             \\ \hline
%		counter        & Zähler der gesendeten Nachrichten             \\\hline
%	\end{tabular}
%	\label{tbl:CountSpalten}
%		\caption{Spalten der Counter-Tabelle}	
%\end{table}
...
{"data":
 {"allTraces":[
	{"userName":"Alexandra",
	 "message":"Hallo Fabi"},
	{"userName":"Fabi",
	 "message":"Hey, na alles klar?"},
	{"userName":"Alexandra",
	 "message":"Ja passt schon und bei dir?"}]
 }
}
\end{lstlisting}
...
\emph{Basic Tutorial: Introduction}

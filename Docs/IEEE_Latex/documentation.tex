...
%Im \ac{JMS}-Provider des Chat-Servers (Wildfly Application-Servers) werden entsprechende Queues und Topics konfiguriert, welche anschließend vom Chat-Client genutzt werden. 

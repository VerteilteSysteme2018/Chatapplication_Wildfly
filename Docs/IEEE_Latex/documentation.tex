...
Neben dem Login und Logout, können über einen GET Request auch alle eingeloggten User geliefert werden. Dies ermöglicht es im Chat Prozess eine Liste mit allen aktuell verfügbaren Chat Nutzern zu generieren (vgl. Abbildung \ref{fig:chatusers}).

...
\newcommand\MYhyperrefoptions{bookmarks=true,bookmarksnumbered=true,
	...
	pdfkeywords={Verteilte Systeme, MOM, Wildfly, JMS, JavaEE, Transactions, Angular, GraphQL}}%<^!CHANGE!
%\ifCLASSINFOpdf
...
%\begin{figure}
%	\centering
%	\includegraphics[scale=0.30]{Bilder/AdminClient_User.JPG}
%	\caption{Chat-Nutzer-Verwaltung des Admin-Clients.}
%	\label{fig:adminClientUser}
%\end{figure}

\lstinline|application/JSON|  
